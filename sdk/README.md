...
TypeScript SDK for the [AgentPlane](https://agentplane.vercel.app) API. Run Claude Code agents in isolated sandboxes.
...
// or set AGENTPLANE_API_KEY environment variable
...
```ts
import { AgentPlaneError } from "agentplane";
...
```ts
import { StreamDisconnectedError } from "agentplane";
...
const client = new AgentPlane({
  ...
  baseUrl: "https://agentplane.vercel.app",     // default
